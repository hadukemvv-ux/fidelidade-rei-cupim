...
- O cron de reconciliação está configurado para a janela de 07:00–07:59 BRT (10:00–10:59 UTC) e atualiza automaticamente a auditoria de comandas já registradas no fluxo novo; ele amplia a consulta até a pendência mais antiga (teto de 90 dias), sem exigir que a gestão abra o sistema. Não concede ponto, cupom, prêmio ou sanção.
