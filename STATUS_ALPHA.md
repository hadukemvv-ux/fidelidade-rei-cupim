...
- Fluxo de venda e fidelidade estavel
...
1. Contrato de schema do sorteio ainda legado (UUID + id_new)
2. Necessidade de evolucao de observabilidade (alertas e metricas)
3. Cobertura de testes unitarios ainda pode crescer
