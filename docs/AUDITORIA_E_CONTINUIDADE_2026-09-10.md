...
- O primeiro deploy da página V2 (`80cbb34`) falhou no prerender porque a leitura do QR precisava de `Suspense`; o commit `8191c64` corrigiu isso e foi confirmado como `Ready` na Vercel em 12/09/2026.
