...
| 22/09/2026 | 6 e 7.1 / primeiro giro pelo QR | Responsável | QR lido e giro de teste registrado com sucesso; prêmio interno sem valor exibido | Comanda da Mesa 200, ID impresso preservado pelo responsável; captura do resultado enviada na conversa | Este teste não valida a nova interface publicada depois, o uso na caixa nem os três cenários planejados. A reconciliação posterior foi verificada em 25/09. |
| 25/09/2026 | 7.1 / reconciliação posterior | Codex, sessão superadmin | ID, total de R$ 220,00, pagamento e não cancelamento conferiram na Saipos. Divergência inicial era falso positivo: QR anterior à mudança de cinco para seis faixas. Registro retificado para compatível com auditoria; relatório diário mostra 1 compatível. | Pedido 878519537; regra histórica `v1_cinco_faixas`; evento `reconciliacao_faixa_historica_retificada` | Ainda faltam medir latência imediata, testar cancelamento e repetir em três comandas novas; nenhum benefício comercial foi liberado. |
| 26/09/2026 manhã BRT | Entregas Saipos / leitura em produção | Codex, sessão superadmin | 100 vendas consultadas; 49 do tipo entrega. 43 com nome de loja no parceiro e 6 sem parceiro informado. Origem de todos os pedidos permanece desconhecida. Histórico de status falhou com código diagnóstico 503; nenhum atraso comprovado. | `/admin/saipos/entregas`, somente leitura, sem dados pessoais no relatório | Repetir histórico com causa de falha detalhada; obter exemplos conhecidos de canal próprio e marketplace; comparar prazo prometido com o horário real antes de considerar compensação. |
| 26/09/2026 manhã BRT | Entregas Saipos / repetição em produção | Codex, sessão superadmin | Histórico respondeu: 104 vendas, 51 entregas. Última etapa: 36 finalizadas, 6 saíram para entrega, 9 em cozinha. Nenhum atraso comprovado; nenhum cupom criado. | `/admin/saipos/entregas`, somente leitura | Endpoint apresentou resposta intermitente. Confirmar origem e prazo de pedidos conhecidos; não automatizar compensação ainda. |
| 26/09/2026 | Origem de delivery / decisão de escopo | Responsável e Codex | Pedido nº 1 (ID `882420214`) confirmado como criado diretamente na Saipos; ainda assim, o campo de loja no parceiro estava preenchido. A API documentada não fornece origem confiável por pedido. | Confirmação do responsável; documentação Saipos de vendas e do relatório “Vendas por período” | Compensação automática por atraso em standby. Preservar diagnóstico, sem classificar origem por heurística, sem emitir cupons. Retomar com identificador oficial verificável. |
