...
const roleLabel = { superadmin: 'Administração total', gestor: 'Gestão — consulta comandas e relatórios', caixa: 'Caixa — valida cupons', garcom: 'Garçom — envia comandas' };
