...
export default function CaixaPage() {
  ...
  return <main className="min-h-screen bg-stone-950 px-4 py-8 text-white"><section className="mx-auto grid max-w-xl gap-5 rounded-2xl border border-amber-500/40 bg-stone-900 p-6 shadow-2xl"><header><div className="flex items-start justify-between gap-4"><div><span className="text-xs font-bold uppercase tracking-[.2em] text-amber-400">O Rei do Cupim · operação</span><h1 className="mt-2 text-3xl font-black">Validar cupom</h1></div><OperationalLogout className="rounded-lg border border-stone-600 px-3 py-2 text-sm font-bold text-stone-200 disabled:opacity-50" /></div><p className="mt-2 text-sm text-stone-300">Leia o QR do cliente ou digite o código recebido no WhatsApp.</p><Link href="/caixa/roleta" className="mt-4 inline-flex rounded-lg border border-amber-400 px-3 py-2 text-sm font-black text-amber-300">Gerar QR da Roleta V2</Link></header>
