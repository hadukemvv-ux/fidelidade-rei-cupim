...
export default function EnviarComandaPage() {
  ...
  return <main className="min-h-screen bg-stone-950 px-4 py-8 text-white"><section className="mx-auto grid max-w-xl gap-5 rounded-2xl border border-amber-500/40 bg-stone-900 p-6 shadow-2xl">
    <header><span className="text-xs font-bold uppercase tracking-[.2em] text-amber-400">O Rei do Cupim · piloto auditável</span><h1 className="mt-2 text-3xl font-black">Comanda e QR de teste</h1><p className="mt-2 text-sm text-stone-300">Duas fotos → leitura do pedido → confirmação do valor → QR único → reconciliação posterior com a Saipos. Nenhum prêmio comercial é válido neste piloto.</p></header>
