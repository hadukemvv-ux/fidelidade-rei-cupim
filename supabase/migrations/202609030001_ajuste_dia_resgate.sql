...
-- O limite diário acompanha o dia civil do restaurante em Fortaleza,
-- independentemente do fuso UTC usado internamente pelo Supabase.
...
begin
  ...
  if exists (
    ...
    where telefone = p_telefone
      and (criado_em at time zone 'America/Fortaleza')::date =
