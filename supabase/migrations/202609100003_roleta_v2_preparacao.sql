...
insert into public.premios_roleta (codigo, versao, nome, descricao_vitoria, descricao_operacional, emoji, cor, tipo, canal_uso, custo_estimado, ativo, participa_roleta, pesos_nivel)
values
 ('frete_gratis_v2', 2, 'Taxa de entrega grátis', 'A próxima entrega é por nossa conta.', 'Uso delivery; validar área atendida e pedido direto.', '🛵', '#22c55e', 'frete_gratis', 'delivery', 8, false, true, array[4,5,6,7,8]),
 ('sobremesa_v2', 2, 'Sobremesa do Rei', 'Escolha pudim, brownie ou dindim gourmet.', 'Validar estoque; permitir substituição equivalente.', '🍮', '#f59e0b', 'sobremesa', 'ambos', 10, false, true, array[3,4,5,6,7]),
 ('saideira_v2', 2, 'Saideira', 'Você ganhou uma cerveja.', 'Somente para maior de 18 anos; validar disponibilidade.', '🍺', '#eab308', 'saideira', 'presencial', 7, false, true, array[2,3,4,5,6]),
 ('expulsadeira_v2', 2, 'Expulsadeira', 'Você ganhou duas cervejas.', 'Somente para maior de 18 anos; validar disponibilidade.', '🍻', '#f97316', 'expulsadeira', 'presencial', 14, false, true, array[1,2,3,4,5]),
 ('desconto_presencial_10_v2', 2, '10% presencial', '10% na sua próxima compra no salão.', 'Não cumulativo; dias úteis, exceto feriados; confirmar no caixa.', '🏪', '#8b5cf6', 'desconto_presencial_10', 'presencial', 12, false, true, array[3,4,5,6,7]),
 ('desconto_delivery_10_v2', 2, '10% delivery', '10% no seu próximo pedido delivery.', 'Não cumulativo; dias úteis, exceto feriados; confirmar pelo atendimento.', '📦', '#3b82f6', 'desconto_delivery_10', 'delivery', 12, false, true, array[3,4,5,6,7])
